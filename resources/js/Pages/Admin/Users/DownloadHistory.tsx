        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="bg-[#0B1120] p-6 rounded-lg shadow-xl overflow-hidden border border-gray-800">
                        ...
                        {history.length === 0 ? (
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-700">
                                    <thead>
                                        <tr className="text-[#2970E8] uppercase tracking-wider text-sm">
                                    ...
                                    <tbody className="divide-y divide-gray-700">
                                        {history.map((record) => (
                                            <tr key={record.id} className="hover:bg-gray-800 transition duration-150">
                                                <td className="px-6 py-4 whitespace-nowrap font-medium text-white">
                                                    {record.downloaded_at}
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap text-[#B3E10F]">
